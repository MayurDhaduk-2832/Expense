              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      model.budgetList.isEmpty ? _placeHolder() :
                      Expanded(
                        child: ListView.builder(
                            padding: EdgeInsets.zero,
                            itemCount: model.budgetList.length,
                            itemBuilder: (context,index){
                              return _transactionItem(model.budgetList[index]);
                            }),
                      ),
                      Padding(
          ...
          children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        model.category!,
                        style: TextStyle(
                            fontSize: SizeUtil.f10, fontWeight: FontWeight.w500),
                      ),
                    ],
                  ),
                ),
                exceedLimit ? Image.asset(StringRes.warningIcon,width: 32,) : const SizedBox()
              ],
            ),
            SizedBox(height: 1.h),
            Text(
            ...
            exceedLimit ? Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize:SizeUtil.f10, fontWeight: FontWeight.w400,color: const Color(0xFFFD3C4A),),
              ),
            ) : const SizedBox(),
          ],
        ),
