            ...
            child: Column(
              ...
              children: [
                CustomDropDownField(
                    title: "Category",
                    selectedValue:
                        _selectCategory.isEmpty ? null : _selectCategory,
                    onChange: (val) {
                      _selectCategory = val!;
                    },
                    itemList: Provider.of<AppDataStore>(context, listen: true)
                        .categoryList),
                SizedBox(
                  height: 2.h,
                ),
                    ...
                    onTap: () {
                      if (_amountController.text.isEmpty) {
                        ...
                        if (_selectCategory.isEmpty) {
                          ...
                          if (isCreateBudget) {
                            if (Provider.of<AppDataStore>(context,
                                    listen: false)
                                .budgetList
                                .any((element) =>
                                    element.category == _selectCategory)) {
                              Fluttertoast.showToast(
                                  msg: "Already exit this category");
                            } else {
