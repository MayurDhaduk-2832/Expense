            ...
            Stack(
              ...
              children: [
                Image.asset(
                  ...
                  width: 100.w,
                  height: Device.screenType == ScreenType.tablet ? 33.h : 28.h,
                  fit: BoxFit.cover,
                ),
                Column(
                  children: [
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(model.accIcon!,
                height: Device.screenType == ScreenType.tablet ? 45 : 24,
                width: Device.screenType == ScreenType.tablet ? 45 : 24),
          ),
          SizedBox(width: 3.w),
          Expanded(
            child: Text(
